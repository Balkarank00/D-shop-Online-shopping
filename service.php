...
<!-- End WOWSlider.com BODY section -->
	...
	<table>
	 <tr><td style="width:30%" height="30px;"><label>Login Id</label></td>
             <td>:&nbsp;<input type="text" class="field" style="width:150px;" name="t12" id="t1" /></td></tr>
	         <tr><td style="width:30%" height="30px;"><label>Password</label></td>
            <td>:&nbsp;<input type="text" class="field" style="width:150px;" name="t2" id="t2" /></td>
			</tr>
	        <tr><td align="right">    &nbsp;<input type="submit" class="search-submit" value="Submit" name="btnsave" id="btnsave" /></td></tr>
			 </table>
	   ...
	   <div id="bodyright"><h2>Services</h2>
	  <p style="font-size:50px">Under construction</p>
	  <table>
	  <tr><td width="270" height="400"></td></tr>
	  </table>
...
<br clear="all"/>
	 ...
	 <div id="footer"><p class="left" style="padding:3px;"> <a href="index.php">Home</a> <span>|</span> <a href="#">Service Area</a> <span>|</span> <a href="#">Term & Condition</a> <span>|</span><a href="contactus.php">Contact Us</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a title="#">&copy; Mail us: james.srt334433@gmail.com</a></p>
...
function checklogin()
{
var a=parseInt(document.getElementById("#").value);
if(a==0)
{
alert("Please Login Before Choose Items");
