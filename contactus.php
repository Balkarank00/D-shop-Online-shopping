...
$sql="INSERT INTO feedback_db(text,phn,email) VALUES('$text','$phn','$email')";
...
<div id="mbf8y1ebul_wrapper" style="max-width: 970px;">
  ...
  <li><div class="buttonbg" style="width: 170px;"><a href="offers.php">OFFERS</a></div></li>
...
<!-- End WOWSlider.com BODY section -->
	 ...
	 <div id="bodyleft">
	   ...
	   <div id="bodyright"><h2 align="center"><font color="#FFFFFF">****Contac Us****</font> </h2>
	   <p align="center"; style="color:#990000; font-size:40px; font-style:italic; font:Arial;"><b>D-Shop</b></p>
	   
	   
	   <table>
		<tr><td width="50"> &nbsp;Rajesh Choudhary</td><td width="200"></td><td><b><font color="#0000FF">Seepat Office</font></b></td></tr>
		<tr><td>&nbsp;Contact:+91-7898721035</td><td width="200"></td><td>Balkaran kumar </td></tr>
		<tr><td>&nbsp;customercare@Dshop.com</td><td width="200"></td><td>Contact: +91-9570159687</td></tr>
		<tr><td>&nbsp;Head office,Bilaspur</td><td width="200"></td><td>koni,Bilaspur</td></tr>
		...
		<br /><br /><br /><br/>
		<form method="post" name="mail" onsubmit="return validate()">
		  <table>
		      <tr><td><b>Problem:</b></td>
		      <td><textarea  name="t1"style="height:100px; width:250px;"></textarea></td></tr>
		<tr><td><b>Phone:</b></td><td><input type="text" name="t2" style="width:250px;"></td></tr>
		<tr><td><b>Email:</b></td><td><input type="text" name="t3"  style="width:250px;"/></td></tr>
		<tr><td colspan="2"> <input type="submit" class="search-submit" value="Send" name="btnmail" /></td></tr>
		</table>
		</form>
...
phn=document.getElementById("t2").value;
