...
<body>
<div id="wrapper">
<div id="header"><img src="image/logo.png" width="970px" height="100px;"/><p style="margin-top:-20px;" align="right"><font size="+1" face="Geneva, Arial, Helvetica, sans-serif" color="#FFFFFF">Call us now:-1800-7777-2342</font></p>
...
<!-- End WOWSlider.com BODY section -->
	...
	<h2 align="center" style="border:1px solid; background-color:#0066FF">Baby Care</h2>
	<?php
	...
	while($row=mysqli_fetch_array($res))
	{
		...
		$item_price=$row[4];
	?>
	<table style="height:200px; width:180px; border:1px solid; float:left; margin-left:15px; margin-top:15px;">	
	<tr>
	<td style="width:30%" height="30px;"><h2 style="border:hidden; background-color:#FF99FF; text-align:center"><?php echo $item_name; ?></h2></td></tr>
	 <tr><td><img src="<?php echo $image; ?>"  width="220" height="180" />&nbsp;</td></tr>
	
	                       <tr><td style="width:30%" height="30px;">Qty:<select name="qty" id="qty">
							...
							</select>&nbsp; &nbsp;Price:Rs<?php echo $item_price; ?></td></tr>
	 <tr><td><input type="image" src="image/button-detail.jpg" name="dbtn" id="dbtn" />&nbsp; &nbsp;
	<input type="image" src="image/button-add-to-cart.jpg" name="addbtn" id="addbtn" align="right" /></td></tr>
</table>	
