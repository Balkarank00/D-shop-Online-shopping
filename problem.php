...
<!-- End WOWSlider.com BODY section -->
	 ...
	 <br clear="all" />
	<div id="body">	
	<table align="center" width="970" border="1">
	<tr>
	<td colspan="20" align="center" bgcolor="#0066FF"><h2>Problem Query</h2></td></tr>
<tr><td align="center">SN no:-</td>
...
<td align="center">Email:-</td></tr>
	...
	<td> <?php echo $text; ?></td>
	<td> <?php echo $phn; ?></td>
	<td align="center" style="width:30%" height="50px;"><?php echo $mail; ?></td></tr>
